...
public class GarcomController {
    ...
    /*@GetMapping("/maiorFaturamento")
    public ResponseEntity<GarcomFaturamentoDTO> obterMaiorFaturamento(@RequestParam LocalDateTime dataInicio, @RequestParam LocalDateTime dataFim) {
        GarcomFaturamentoDTO garcomFaturamentoDTO = garcomService.obterMaiorFaturamento(dataInicio, dataFim);
        return ResponseEntity.status(HttpStatus.OK).body(garcomFaturamentoDTO);
    }*/
